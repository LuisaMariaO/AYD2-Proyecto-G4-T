...
function LoginConductor() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://34.44.160.131:9000/conductor/login', {
                method: 'POST',
    ...
    const handleCodigoSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://34.44.160.131:9000/conductor/loginCodigo', { // Nuevo endpoint
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handlePasswordChange = async () => {
        ...
        try {
            const response = await fetch('http://34.44.160.131:9000/conductor/actualizarContrasena', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
