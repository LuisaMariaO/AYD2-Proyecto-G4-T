...
function ReportarProblema() {
    ...
    useEffect(() => {
        const fetchCategorias = async () => {
            try {
                const response = await fetch('http://34.44.160.131:9000/conductor/categoriasProblema');
    ...
    useEffect(() => {
        const fetchViajes = async () => {
            try {
                if (conductorId) {
                    const response = await fetch(`http://34.44.160.131:9000/conductor/viajesConductor/${conductorId}`);
                    const result = await response.json();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://34.44.160.131:9000/conductor/reportarProblema', {
                method: 'POST',
