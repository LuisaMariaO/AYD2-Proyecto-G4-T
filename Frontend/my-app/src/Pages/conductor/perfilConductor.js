...
function PerfilConductor() {
    ...
    useEffect(() => {
        const fetchMarcas = async () => {
            try {
                const response = await fetch('http://34.44.160.131:9000/conductor/marcas');
    ...
    useEffect(() => {
        ...
        const fetchConductorInfo = async () => {
            try {
                const response = await fetch('http://34.44.160.131:9000/conductor/perfil', {
                    method: 'POST',
    ...
    const handleActualizar = async (e) => {
        ...
        try {
            const response = await fetch('http://34.44.160.131:9000/conductor/perfil/update', {
                method: 'POST',
                headers: {
